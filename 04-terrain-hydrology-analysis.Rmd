...
knitr::include_graphics('images/04-terrain.jpg')
```
...
knitr::include_graphics('images/04-nahmint.jpg')
```
...
knitr::include_graphics('images/04-sink.jpg')
```
...
``` {r, echo=FALSE, fig.align = 'center', out.width = "40%"}
knitr::include_graphics("images/04-flowDir.jpg")
```
...
``` {r, echo=FALSE, fig.align = 'center', out.width = "100%",}
knitr::include_graphics("images/04-flowDir2.jpg")
```
...
``` {r, echo=FALSE, fig.align = 'center', out.width = "100%",}
knitr::include_graphics("images/04-streams.jpg")
```
...
##### Q9: Compare your stream network to the streams visible in the ArcGIS satellite basemaps. Experiment with different flow accumulation thresholds. Which one seems to represent **major streams** in the satellite basemaps best? What other land cover/infrastructure in this region may make it difficult to verify smaller stream networks?  {.unnumbered} 
...
knitr::include_graphics("images/04-reclassify.jpg")
```
...
``` {r, echo=FALSE, fig.align = 'center', out.width = "100%"}
knitr::include_graphics("images/04-maplayers.jpg")
```

##### Q10: How many unique watersheds did you define? What is the area of the largest watershed area? Report your answer in km2 and round to 2 decimal places. HINT: Examine the raster attribute table to estimate watershed area. {.unnumbered} 
