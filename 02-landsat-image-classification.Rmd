...
```{r 02-arcgispo-create-accuracy-assessment-points, out.width= "100%", echo = FALSE}
    knitr::include_graphics("images/02-arcgispro-create-accuracy-assessment-points.png")
```
...
```{r 02-arcgispro-set-null, out.width= "40%", echo = FALSE}
    knitr::include_graphics("images/02-arcgispro-set-null.png")
```
...
**Step 8:** From the Geoprocessing pane, search for the "Compute Confusion Matrix" tool (Spatial Analyst). Use the "eosd_accuracy_assessment_points" as the Input Accuracy Assessment Points and save the output as "confusion_matrix" in your geodatabase then run the tool.
