...
We will be using a Landsat 9 Operational Land Imager 2 (OLI-2) multispectral image and other metadata that are distributed with this product. Additionally, there is a point dataset that contains a stratified random sample of accuracy assessment points that we will use to generate a confusion matrix in ArcGIS Pro. You can download these data from the course management system.
...
```{r 02-arcgispro-composite-bands, out.width= "40%", echo = FALSE}
    knitr::include_graphics("images/02-arcgispro-composite-bands.png")
```
...
```{r 02-arcgispro-654, out.width= "100%", echo = FALSE}
    knitr::include_graphics("images/02-arcgispro-654.png")
```
...
```{r 02-arcgispro-band-arithmetic, out.width= "40%", echo = FALSE}
    knitr::include_graphics("images/02-arcgispro-band-arithmetic.png")
```
...
```{r 02-arcgispro-reclassify, out.width= "40%", echo = FALSE}
    knitr::include_graphics("images/02-arcgispro-reclassify.png")
```
...
```{r 02-arcgispro-reclassify-ndvi, out.width= "40%", echo = FALSE}
    knitr::include_graphics("images/02-arcgispro-reclassify-ndvi.png")
```
...
```{r 02-arcgispro-classify, out.width= "40%", echo = FALSE}
    knitr::include_graphics("images/02-arcgispro-classify.png")
```
...
```{r 02-arcgispro-iso-cluster, out.width= "100%", echo = FALSE}
    knitr::include_graphics("images/02-arcgispro-iso-cluster.png")
```
...
```{r 02-arcgispro-training-samples-manager, out.width= "40%", echo = FALSE}
    knitr::include_graphics("images/02-arcgispro-training-samples-manager.png")
```
...
```{r 02-arcgispro-nlcd2011, out.width= "40%", echo = FALSE}
    knitr::include_graphics("images/02-arcgispro-nlcd2011.png")
```

```{r 02-arcgispro-create-new-schema, out.width= "40%", echo = FALSE}
    knitr::include_graphics("images/02-arcgispro-create-new-schema.png")
```
...
```{r 02-arcgispro-eosd, out.width= "40%", echo = FALSE}
    knitr::include_graphics("images/02-arcgispro-eosd.png")
```
...
```{r 02-arcgispro-digitize-training-samples, out.width= "100%", echo = FALSE}
    knitr::include_graphics("images/02-arcgispro-digitize-training-samples.png")
```

From the course management system, download the **eosd_accuracy_assessment_points** layer. This is a randomly stratified set of points that can be used for generating the accuracy assessment in ArcGIS Pro.

```{r 02-arcgispro-accuracy-assessment-points-attributes, out.width= "75%", echo = FALSE}
    knitr::include_graphics("images/02-arcgispro-accuracy-assessment-points-attributes.png")
```

**Step 5:** From the Geoprocessing pane, search for the "Update Accuracy Assessment Points" tool (Spatial Analyst). Select the "EOSD_Classified" image that you classified earlier as the Input Raster. The Input and Output Accuracy Assessment Points can be the same points that you created in the last step. Change the "Target Field" to "Classified", leave "Dimension Field for Test points" blank, and then run the tool.

```{r 02-arcgispro-update-accuracy-assessment-points, out.width= "40%", echo = FALSE}
    knitr::include_graphics("images/02-arcgispro-update-accuracy-assessment-points.png")
```

**Step 6:** From the Geoprocessing pane, search for the "Compute Confusion Matrix" tool (Spatial Analyst). Use the "eosd_accuracy_assessment_points" as the Input Accuracy Assessment Points and save the output as "confusion_matrix" in your geodatabase then run the tool.

```{r 02-arcgispro-confusion-matrix, out.width= "100%", echo = FALSE}
    knitr::include_graphics("images/02-arcgispro-confusion-matrix.png")
```
