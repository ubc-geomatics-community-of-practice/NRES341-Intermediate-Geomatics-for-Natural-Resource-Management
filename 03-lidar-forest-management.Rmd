...
knitr::include_graphics('images/03-river_pointcloud.png')
```
...
THe data is split up into a tiled grid system. You will download one tile covering a section of UBC. Use the **Table** view and search for the following tile and download it: **4840E_54550N** by clicking on the .zip link. You can select the "Map" and then look at the tiles that cover Pacific Spirit Park.

Use the metadata from the City of Vancouver data portal to answer the following questions: 

##### Q1. What is the horizontal and vertical datum of the LAS dataset? Why is it important for Lidar data to have both horizontal AND vertical datums? {-}

##### Q2: What is the point density of the dataset (points per m^2^)? {-}

**Step 2:** Create a new ArcGIS **Map Project** and save it to the default directory. 
...
``` {r, echo=FALSE, out.width = "50%", fig.align = 'center', out.width = "50%"}
knitr::include_graphics('images/03-lasd.jpg')
```
...
knitr::include_graphics('images/03-filter.jpg')
```
...
``` {r, echo=FALSE, fig.align = 'center', out.width = "50%"}
knitr::include_graphics('images/03-dem.jpg')
```
...
``` {r, echo=FALSE, fig.align = 'center', out.width = "50%"}
knitr::include_graphics('images/03-RasterCalc.jpg')
```
...
``` {r, echo=FALSE, fig.align = 'center', out.width = "50%"}
knitr::include_graphics("images/03-Calc.jpg")
```
...
``` {r, echo=FALSE, out.width = "100%", fig.align = 'center'}
knitr::include_graphics("images/03-treetops_rast.jpg")
```
...
knitr::include_graphics('images/03-nav1.jpg')
```
``` {r, echo=FALSE, fig.align = 'center', out.width = "20%"}
knitr::include_graphics('images/03-nav2.jpg')
```
...
knitr::include_graphics('images/03-example.jpg')
```