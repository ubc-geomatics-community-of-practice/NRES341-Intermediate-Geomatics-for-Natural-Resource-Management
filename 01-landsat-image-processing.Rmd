...
knitr::include_graphics('images/01-lsat.jpg')
```
...
knitr::include_graphics('images/01-wrs.jpg')
```
...
##### Q1. For the Landsat scenes you are given, what Landsat sensor and satellite do the images come from? When were the images acquired? {.unnumbered} 
...
knitr::include_graphics('images/01-nocorr.jpg')
```

``` {r, echo=FALSE, out.width = "50%", fig.align = 'center'}
knitr::include_graphics('images/01-corr.jpg')
```
...
``` {r, echo=FALSE, out.width = "75%", fig.align = 'center'}
knitr::include_graphics('images/01-arc.jpg')
```
...
knitr::include_graphics('images/01-proj.jpg')
```
...
knitr::include_graphics('images/01-qabits.jpg')
```
...
``` {r, echo=FALSE, out.width = "60%", fig.align = 'center'}
knitr::include_graphics('images/01-bit3.jpg')
```
...
``` {r, echo=FALSE, out.width = "60%", fig.align = 'center'}
knitr::include_graphics('images/01-bit89.jpg')
```
...
``` {r, echo=FALSE, out.width = "100%", fig.align = 'center'}
knitr::include_graphics('images/01-qaband.jpg')
```
...
knitr::include_graphics('images/01-reclass.jpg')
```

You should now have a raster that looks like this: 

``` {r, echo=FALSE, fig.align = 'center'}
knitr::include_graphics('images/01-rastmask.jpg')
```
...
``` {r, echo=FALSE, fig.align = 'center'}
knitr::include_graphics('images/01-stretch.jpg')
```
...
``` {r, echo=FALSE, out.width = "75%", fig.align = 'center'}
knitr::include_graphics('images/01-symbol.jpg')
```
...
``` {r, echo=FALSE, out.width = "75%", fig.align = 'center'}
knitr::include_graphics('images/01-minmax.jpg')
```
...
``` {r, echo=FALSE, out.width = "75%", fig.align = 'center'}
knitr::include_graphics('images/01-focalmax.jpg')
```
...
``` {r, echo=FALSE, out.width = "50%", fig.align = 'center'}
knitr::include_graphics('images/01-focalmean.jpg')
```
