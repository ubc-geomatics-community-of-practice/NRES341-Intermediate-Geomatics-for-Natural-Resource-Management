...
In partnership with the Delta community, the Collaborative for Advanced Landscape Planning (CALP) research group at UBC produced the following report on projected sea level rise and adaptation strategies for this region, which can be found here:

<a href="https://raw.githubusercontent.com/ubc-geomatics-community-of-practice/NRES341-Intermediate-Geomatics-for-Natural-Resource-Management/refs/heads/main/data/05/BCRAC_Delta_Visioning-Policy_4d.pdf?raw=true" target="_blank">Delta-RAC Sea Level Rise Adaptation Visioning Study (54.4 MB)</a>

```{r, echo=FALSE, fig.align = 'center', out.width = "100%"}
knitr::include_graphics('images/05-CALP.jpg')
```
...
knitr::include_graphics('images/05-reclassify.jpg')
```
...
knitr::include_graphics('images/05-reclasstable.jpg')
```
...
```{r, echo=FALSE, fig.align = 'center', out.width = "75%"}
knitr::include_graphics('images/05-delete.jpg')
```
...
Delete the selected features. Select the "Edit" tab at the top and then select "Save" to save the edits.x
...
knitr::include_graphics('images/05-attributes.jpg')
```
...
```{r, echo=FALSE, fig.align = 'center', out.width = "100%"}
knitr::include_graphics('images/05-addField.jpg')
```

In the Fields table name the new field **Int_Area**, set the data type to **Double** and then click Save (at the top of map window).

```{r, echo=FALSE, fig.align = 'center', out.width = "100%"}
knitr::include_graphics('images/05-newfield.jpg')
```

You will now have a empty field in the attribute table.

In the attribute table, right-click on the "Int_Area" field \> Calculate Geometry. In the Property drop-down select "Area" and select "Square meters" as the Area Unit. Click OK. Right-click on the "Int_Area" field from the attribute table and select "Explore statistics".

##### Q8. What is the total area of agricultural land is impacted by flooding? Report the final answer in km^2^ and round to two decimal places. {.unnumbered}
...
```{r, echo=FALSE, fig.align = 'center', out.width = "50%"}
knitr::include_graphics('images/05-calcField.jpg')
```
...
-   Input Field: flood_ag_intersect
-   Join Table: LRPLD
-   **Un-check** Keep all input records
